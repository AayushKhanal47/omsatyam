        ...
        <div className="relative grid items-center gap-10 lg:grid-cols-[1.4fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-white/75">
              Tell us how many chairs, your specialities and your budget. We'll suggest a complete equipment list —
              chairs, X-ray, sterilisation, instruments and starting stock — and send you one quote.
            </p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col lg:items-end">
            ...
            >
              Plan my clinic <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </a>
            <Link
              to="/contact"
